...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void getlokasi(){
        String url="https://gisuts.000webhostapp.com/paragliding.php";
                                ...
                                for(int i=0;i<jumData;i++){
                                    if(marker.getTitle().equals(nama[i])){
                                        if (MarkerD[i]){
                                            ...
                                            DetailActivity.tempat=alamat[i];
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this,"klik sekali lagi untuk detail",Toast.LENGTH_LONG);
